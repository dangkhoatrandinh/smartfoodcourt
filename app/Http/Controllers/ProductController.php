...
class ProductController extends Controller
{
    ...
    public function xemproduct() {
    	...
    	if ($message) {
    		...
    		$product_data = DB::table('tbl_product')->join('tbl_category_product','tbl_product.category_id','=','tbl_category_product.category_id')->join('tbl_brand','tbl_product.brand_id','=','tbl_brand.brand_id')->orderby('product_id')->get();
    ...
    public function viewproductbyid($product_id) {
        ...
        $product_data = DB::table('tbl_product')->join('tbl_category_product','tbl_product.category_id','=','tbl_category_product.category_id')->join('tbl_brand','tbl_product.brand_id','=','tbl_brand.brand_id')->where('product_id',$product_id)->get();
        return view('pages.productdetail')->with('cate_product',$cate_product)->with('brand_product',$brand_product)->with('product_data',$product_data); 
    }
}
